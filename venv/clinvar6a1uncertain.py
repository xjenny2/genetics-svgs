...
import os
import argparse
from functionsclinvar import readresultsascending, percent_pathogenic, percent_vus, edits
...
if os.path.exists(args.startfile):
    ...
    with open(args.startfile) as tsv:
        ...
        with open(args.destination, 'w') as f:
            ...
            # VWA "fill:#ffbf56; fill-opacity: 0.6; stroke: #ffa716; stroke-width:1
            f.write('\n<!-- VWA -->\n')
            f.write(
            ...
            for sublist in results:
                ...
                # # nonsense
                # if sublist[1] == 0 and sublist[2] == 2:
                #     fill = '#ffde72'  # yellow
                #     stroke = '#ffa716'
                #     f.write(
                #         '\t<polygon points="' + start + ',20 ' + end + ',20 ' + mid + ',35" '
                ...
                #     )
                # # gly
                # elif sublist[1] == 0 and sublist[2] == 1:
                #     fill = '#9f9eff'  # purple
                #     stroke = '#7270ff'
                #     f.write(
                #         '\t<polygon points="' + start + ',20 ' + end + ',20 ' + mid + ',35" '
