import re
import csv
from functionsgnomad import readresults, checkdescending
with open("/Users/jennyxu/Desktop/genetics/gnomad_col6a3_canonical") as csvDataFile:
    reader = csv.DictReader(csvDataFile)  # sets up file as dictionary with first line as header
    raw_results = readresults(reader)
    results, errors = checkdescending(raw_results)
    print results
    print errors
...
# to do: CHECK MATH FOR ZOOMED IN FIGURE
