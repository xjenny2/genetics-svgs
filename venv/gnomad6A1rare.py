...
with open("/Users/jennyxu/Desktop/genetics/gnomad_col6A1") as csvDataFile:
    ...
    with open('/Users/jennyxu/Desktop/genetics/gnomad_col6A1_rare.html', 'w') as f:
        ...
        f.write(
            ...
            'style = "font-size: 10; font-weight: bold; fill: #00E408">.25% < Freq &le; .5%</text>\n\n'
        )
        # key PURPLE
        f.write(
        ...
        for n in range(0, 4):
            ...
            f.write('\n<!-- TRIPLE HELICAL REGION -->\n')
            f.write(
                '\t<polygon points="514,' + str(base - 6) + ' 1184,' + str(base - 6) + ' 1184,'
                + str(base + 6) + ' 514,' + str(base + 6) + '" '
        ...
        f.write(
            '\t<polygon points="10,' + str(600 - 12) + ' 2020,' + str(600 - 12) + ' 2020,'
            + str(600 + 12) + ' 10,' + str(600 + 12) + '" '
            'style = "fill: #00ffe9; fill-opacity: 0.6; stroke: #3ca390; stroke-width:2" />\n\n'
        )
        f.write(
            '\t<line x1="10" y1="' + str(600) + '" x2="2020" y2="' + str(600) + '" '
            'style="stroke: #000000; stroke-width:3; stroke-linecap: round" />\n'
        )
        f.write(
            '<text text-anchor="start" x="1" y="' + str(600 + 30) + '" '
            'style = "font-size: 12px;">257</text>'
        )
        f.write(
            '\t<text text-anchor="middle" x="2020" y="' + str(600 + 30) + '" '
            'style = "font-size: 12px;">592</text>\n\n'
        )
        position = 268
        while 10 <= position <= 2020:
            f.write(
                '\t<line x1=' + str(position) + ' y1="' + str(600 - 10) +
                '" x2=' + str(position) + ' y2="' + str(600 + 10) + '" '
                'style="stroke: #000000; stroke-width:3; stroke-linecap: round" />\n'
            )
            position += 600
        ...
        for sublist in results:
            ...
            start1 = str(num * 6 - 1532 - 7)
            mid1 = str(num * 6 - 1532)
            end1 = str(num * 6 - 1532 + 7)
            if sublist[2] == 1:
                fill = '#8d02ff'  # purple
                stroke = '#23004c'
            if 514 < int(mid) < 1184:
                f.write(
                    '\t<polygon points="' + start1 + ',570 ' + end1 + ',570 ' + mid1 + ',585" '
                    'style = "fill: ' + fill + '; stroke: ' + stroke + '; stroke-width:1" />\n'
                )
                f.write(
                    '\t<line x1="' + mid1 + '" y1="584" x2="' + mid1 + '" y2="599" '
