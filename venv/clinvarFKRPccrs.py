...
import os
import argparse
from functionsclinvar import readresultsfkrp, percent_pathogenic, percent_vus, edits, ccrs
...
if os.path.exists(args.startfile):
    ...
    with open(args.edits) as tsv:
        ...
        edits_list = edits(editsfile, '077277')

    with open("/Users/jennyxu/Desktop/genetics/FKRP_ccrs") as tsv:
        ...
        with open(args.destination, 'w') as f:
            ...
            for sublist in results:
                ...
                if (sublist[1] == 1 or sublist[1] == 2) and sublist[2] == 1: #TER
                    fill = '#ffde72'  # yellow
                    stroke = '#ffa716'
                    f.write(
                        '\t<polygon points="' + start + ',20 ' + end + ',20 ' + mid + ',35" '
            ...
            for sublist in edits_list:
                ...
                f.write(
                    '<circle cx="' + editpos + '" cy="12" r="4" stroke-width=".5" />'
                )
